...
stub_approval_event = {
    'Records': [{
        'EventSource': 'aws:sns',
        'EventVersion': '1.0',
        'EventSubscriptionArn': f'arn:{PARTITION}:sns:eu-central-1:9999999:adf-pipeline-sample-vpc-PipelineSNSTopic-example',
        'Sns': {
            'Type': 'Notification',
            'MessageId': '1',
            'TopicArn': f'arn:{PARTITION}:sns:eu-central-1:9999999:adf-pipeline-sample-vpc-PipelineSNSTopic-example',
